...
public class SecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> {
            ...
            // 放行 TbUserController 的所有接口
            web.ignoring().requestMatchers("/api/v1/tbUsers/**"); // 这里添加放行的路径
            web.ignoring().requestMatchers("/api/v1/thesis/**");
            web.ignoring().requestMatchers("/api/v1/detect/**");
            web.ignoring().requestMatchers("/api/v1/aigcRecordss/**");
            web.ignoring().requestMatchers("/api/v1/aigcOrders/**");
            web.ignoring().requestMatchers("/api/v1/aiOrders/**");
        };
    }
