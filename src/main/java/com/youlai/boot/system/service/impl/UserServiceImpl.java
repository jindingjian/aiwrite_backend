...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public BigDecimal getBalance(Long userId) {
        return this.getBaseMapper().getBalanceByUserId(userId);
    }

    @Override
    public Long getUserIdByUsername(String username) {
        return this.getBaseMapper().getUserIdByUsername(username);
    }

    @Override
    public List<UserForm> getParentIdByUserId(Long userId) {
        return this.getBaseMapper().getParentIdByUserId(userId);
    }

    @Override
    public Boolean updateBalance(BigDecimal balance, Long userId) {
        return this.getBaseMapper().updateBalance(balance,userId);
    }
